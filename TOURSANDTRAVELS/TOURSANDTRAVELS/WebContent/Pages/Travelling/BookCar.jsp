...
<TABLE WIDTH=580 align=center cellspacing=0 cellpadding=0
	...
	<TR>
		<Th style='color: green'><BR>
		<B>
		<center>Travel Management</center>
		</B><BR>
		</TD>
	</TR>
	<FORM name=mainform method=post action="<%=path + "/carconfirm"%>"></FORM>
</TABLE>
<table cellspacing=0 cellpadding=4>
	...
	<TR>
		...
		<td><select name="type" onChange="javascript:doEnable();">
			<option value="RT">Round Trip<%
				i = 2;
			%>
			</option>
			<option value="OW">One Way<%
				i = 1;
			%>
			</option>
		</select></TD>
	...
	<tr>
		<td align=right>Drop-off City&nbsp;&nbsp;:&nbsp;&nbsp;</td>
		<td><select name="dropoffcity" size="1" id="dropoffcity">
	...
	<TR>
		...
		</select> <select name="smm" id="select36">
		...
		</select> <select name="syy" id="select37">
	...
	<TR>
		...
		<TD><select name="ddd" id="ddd">
			...
			<option value="30">30</option>
			<option value="31">31</option>
		</select> <select name="dmm" size="1" id="dmm">
			<option value="01">JAN</option>
			<option value="02">FEB</option>
			<option value="03">MAR</option>
			<option value="04">APR</option>
			...
			<option value="11">NOV</option>
			<option value="12">DEC</option>
		</select> <select name="dyy" size="1" id="dyy">
	...
	<TR>
		...
		<TD><SELECT class=font9 id=select2 name=pickuptime>
	...
	<TR>
		...
		<TD><SELECT class=font9 id=select3 name=dropofftime>
			<OPTION value=00:00>00:00</OPTION>
			<OPTION value=00:15>00:15</OPTION>
			<OPTION value=00:30>00:30</OPTION>
			<OPTION value=00:45>00:45</OPTION>
	...
	<TR>
		...
		<TD align=right>CAR POOLING&nbsp;&nbsp;:&nbsp;&nbsp;</TD>
		<TD><select name="ppp" id="ppp">
	...
	<TD align=right>NUMBER OF PERSONS CAR
	POOLING&nbsp;&nbsp;:&nbsp;&nbsp;</TD>
	<TD><select name="ppn" id="ppn">
	...
	<TR>
		...
		<FORM name=mainform method=post action="<%=path + "/carconfirm"%>"></FORM>
		<button onclick="javascript:doSubmit()">Book Car</button>
		</TD>
	</TR>
	<form name=mainform method=post action="<%=path + "/carconfirm"%>"></form>
</tABLE>
