...
<TABLE WIDTH=580 align=center cellspacing=0 cellpadding=0
	...
	<TR>
		<Td align=center><BR>
		Search&nbsp;:&nbsp;<input type=text name=search class=input>&nbsp;&nbsp;
		<button accesskey='S'><u>S</u>earch</button>
		&nbsp;&nbsp;<a href='advanced.htm'>Advanced Search</a><BR>
		<BR>
		</Th>
	</TR>
	<TR>"WebContent/Pages/Holiday/BookPackage.jsp.bak"
