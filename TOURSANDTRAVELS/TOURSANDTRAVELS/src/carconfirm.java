        ...
        //    query = new String("select * from flightbooking"); 
            ...
            */
            	reqno =500;
            	 ...
            	 query = new String("insert into carbooking values('"+loginid+"','"+type+"','"+pickupcity+"','"+dropoffcity+"','"+sdd+"','"+smm+"','"+syy+"','"+ddd+"','"+dmm+"','"+dyy+"','"+pickuptime+"','"+dropofftime+"','"+ppp+"','"+ppn+"','"+carclass+"','"+cardno+"')");
